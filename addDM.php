...
<?php
	if(isset($_SESSION['thongbaoad'])) {
		...
		echo '<script>document.getElementById("thongbaoad").innerHTML="<b>!!Thêm Danh Mục Thất Bại - Tên File Bị Trùng!!</b>";
		...
		echo '<script>document.getElementById("thongbaoad").innerHTML="<b>!!Thêm Danh Mục Thất Bại - File Không Phù Hợp!!</b>";
			document.getElementById("thongbaoad").style.display="block";
			document.getElementById("thongbaoad").style.color="#FF0000";
			function closeTB(){
			document.getElementById("thongbaoad").style.display="none";
		...
		echo '<script>document.getElementById("thongbaoad").innerHTML="<b>!!Thêm Danh Mục Thất Bại - Tên Hoặc Mã Danh Mục Đã Tồn Tại!!</b>";
			document.getElementById("thongbaoad").style.display="block";
			document.getElementById("thongbaoad").style.color="#FF0000";
			function closeTB(){
			document.getElementById("thongbaoad").style.display="none";
		...
		echo '<script>document.getElementById("thongbaoad").innerHTML="<b>Thêm Danh Mục Thành Công!</b>";
			document.getElementById("thongbaoad").style.display="block";
			function closeTB(){
			document.getElementById("thongbaoad").style.display="none";
			}
...
<h1 style="font-feature-settings: 'kern'; margin-top:30px; margin-left:30px"><b>THÊM DANH MỤC MỚI</b></h1>
<p style="width:35%; font-feature-settings: 'kern'; font-size:22px; text-align:center; margin:auto; margin-top:50px">THIẾT LẬP THÔNG TIN DANH MỤC<i class="fas fa-clipboard-list" style="margin-left:10px"></i></p>
...
<div style="width:45%; float:left; height:100%; background:#fff; margin-left:28%; position:relative">
	<form method="post" action="xuliaddDM.php" enctype="multipart/form-data">
    <h5 style="margin-left:40px; margin-top:30px">Mã Danh Mục</h5>
    <div class="input-group mb-3" style="width:75%; margin-left:40px">
      <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="idDM" id="idDM" >
    </div>
    ...
    <div class="input-group mb-3" style="width:75%; margin-left:40px">
      <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="stt" id="stt" >
    </div>
    ...
    <div class="input-group mb-3" style="width:75%; margin-left:40px">
      <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" name="name" id="nameid" >
    </div>
    ...
    <input type="submit" class="btn btn-outline-success" style="float:left; height:100%; width:25%; font-size:22px; border:solid 3px" value="Thêm Mới" onclick="return checkTTDM();"></input>
...
function checkNameDM(){
	...
	if(name=="")	{document.getElementById("error3").innerHTML='<i class="fas fa-exclamation-circle"></i> Tên danh mục không được bỏ trống';
			return false;	}
...
function checkIDDM(){
	...
	if(ID=="")	{document.getElementById("error1").innerHTML='<i class="fas fa-exclamation-circle"></i> Mã danh mục không được bỏ trống';
			return false;	}
...
function checkSTT(){
	...
	if(STT=="")	{document.getElementById("error2").innerHTML='<i class="fas fa-exclamation-circle"></i> Thứ tự danh mục không được bỏ trống';
			return false;	}
